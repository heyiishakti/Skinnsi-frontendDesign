              ...
              <div className='threeCards'>
                    <div className='boxCard' style={{margin: '20px 0px 0px 370px', background:'#e03c31'}}>
                      ...
                      <div className='textEnd'>
                          <h5>Nandini Rajpurohit</h5>
                            <p>Google Reviews - September 2021</p>
                      </div>
                    </div>
                    <div className='boxCards' style={{margin: '20px 0px 0px 0px', background:'white'}}>
                      ...
                      <hr />
                      <div className='textEnd'>
                          <h5 style={{color:'#e03c31'}}>Renu Rathore</h5>
                            <p style={{color:'#e03c31'}}>Google Reviews - October 2021</p>
                      </div>
                    </div>
                    <div className='boxCard'style={{margin: '20px 370px 0px 0px'}}>
                      ...
                      <div className='textEnd'>
                          <h5 style={{color:'#424242', padding:'6px 0px 0px 0px'}}>Neetu Shekhawat</h5>
                            <p style={{color:'#424242'}}>Google Reviews - November 2021</p>
                      </div>
                    </div>
                </div>
                <div className='threeCards'>
                    <div className='boxCard' style={{margin: '20px 0px 0px 370px', background:'#424242'}} >
                      <p style={{margin:'180px 0px 0px 0px'}}>
                       ...
                       <hr style={{ margin: '180px 0px 0px 0px' }} />
                      <div className='textEnd'>
                          <h5 style={{color:'white', padding:'6px 0px 0px 0px'}}>Priyanka Rathore</h5>
                    ...
                    <div className='boxCard' style={{margin: '20px 0px 0px 0px', background:'#e03c31'}}>
                      ...
                      <div className='textEnd'>
                          <h5 style={{color:'white', padding:'6px 0px 0px 0px'}}>Tanu Kanwar</h5>
                            <p style={{color:'rgb(255, 255, 255)'}}>Google Reviews - December 2021</p>
                      </div>
                    </div>
                    <div className='boxCards' style={{margin: '20px 370px 0px 0px', background:'white'}}>
                      ...
                      <hr />
                      <div className='textEnd'>
                          <h5 style={{color:'#e03c31'}}>Khushi Gaur</h5>
                            <p style={{color:'#e03c31'}}>Google Reviews - October 2021</p>
                      </div>
                    </div>
                </div>
